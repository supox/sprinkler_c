...
${OBJECTDIR}/reading_data.o: reading_data.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/reading_data.o reading_data.c
...
${OBJECTDIR}/reading_data_nomain.o: ${OBJECTDIR}/reading_data.o reading_data.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/reading_data_nomain.o reading_data.c;\
	else  \
